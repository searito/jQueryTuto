...
<head>
	...
	<title>jQuery > Evento keydown</title>
	...
	<div class="container-fluid colorAcentuado" id="fondoPag">
		<div class="container bg-white">
			<div class="jumbotron bg-transparent">
				<h3 class="text-center fuenteTuneada colorPrincipal titulos" id="titulo_rebote">Evento keydown</h3>
			</div>
			...
			<div class="card espacioBajo fondoClaro">
				<div class="card-body">
					<div class="row">
						...
						<div class="col-sm-6">
							<div class="row">
								<div id="box1" class="espacioBajo margenesInternos"></div>
							</div>

							<div class="row">
								<div id="box2" class="espacioBajo margenesInternos"></div>
							</div>
						</div>
					</div>
				</div>
	...
	<script>
		$(document).ready(function() {
			...
			$("#txt_nombre").keydown(function() {
				...
				$("#box1").html('<h5 class="fuenteTuneada">Contenido De La Caja Nombre</h5>' + contenido);
			});


			$("#txt_mail").keydown(function() {
				$(this).css({
				...
				var correo = $(this).val();
				$("#box2").html('<h5 class="fuenteTuneada">Contenido De La Caja Correo</h5>' + correo);
			});
		});
	</script>
</body>
