...
<head>
	...
	<title>jQuery > Evento Doble Click</title>
...
<body>
	<div class="container-fluid colorAcentuado" id="fondoPag">
		<div class="container bg-white">
			<div class="jumbotron bg-transparent">
				<h3 class="text-center fuenteTuneada colorPrincipal titulos" id="titulo_rebote">Evento Doble Click</h3>
			</div>
			...
			<div class="card espacioBajo fondoClaro">
				<div class="card-body">
					<div class="row">
						<div class="col-sm-6">
							<p id="parrafo1">Koyomi Araragi</p>
							<p id="parrafo2">Karen Araragi</p>
							<p id="parrafo3">Tsukihi Araragi</p>
						</div>
	...
	<script>
		$(document).ready(function() {
			...
			$("#parrafo1").dblclick(function() {
				$(this).fadeOut(700);
			});

			$("#parrafo2").dblclick(function() {
				$(this).fadeOut(700);
			});
