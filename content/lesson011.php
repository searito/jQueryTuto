...
<head>
	...
	<title>jQuery > Método removeAttr</title>
	...
	<div class="container-fluid colorAcentuado" id="fondoPag">
		<div class="container bg-white">
			<div class="jumbotron bg-transparent">
				<h3 class="text-center fuenteTuneada colorPrincipal titulos" id="titulo_rebote">Método removeAttr</h3>
			</div>
			...
			<div class="card espacioBajo fondoClaro">
				<div class="card-body">
					<div class="row">
						<div class="col-sm-5">
							<h3 id="parrafo1">Kiss Shot Acerola Orion Heart Under Blade</h3>
						</div>

						<div class="col-sm-2">
							<button id="btn_remover" class="btn btn-dark btn-block" title="Remover Atributos">
								<i class="fa fa-minus-circle" aria-hidden="true"></i>
							</button>
						</div>

						<div class="col-sm-5">
							<h3 class="miClase3">Kiss Shot Acerola Orion Heart Under Blade</h3>
						</div>
					</div>
				</div>
			</div>
