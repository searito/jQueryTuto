...
<head>
	...
	<title>jQuery > Evento mouseout</title>
	...
	<div class="container-fluid colorAcentuado" id="fondoPag">
		<div class="container bg-white">
			<div class="jumbotron bg-transparent">
				<h3 class="text-center fuenteTuneada colorPrincipal titulos" id="titulo_rebote">Evento Mouseout</h3>
			</div>
			...
			<div class="card espacioBajo fondoClaro">
				<div class="card-body">
					<div class="row">
						<div class="col-sm-6">
							<div id="parrafo1">
								Kiss Shot Acerola Orion Hearth Under Blade

								<img src="https://img00.deviantart.net/b627/i/2016/096/a/5/kiss_shot_acerola_orion_heart_under_blade_by_blackmoon329-d9ue6cp.png" 
