...
<head>
	...
	<title>jQuery > Método addClass</title>
	...
	<div class="container-fluid colorAcentuado" id="fondoPag">
		<div class="container bg-white">
			<div class="jumbotron bg-transparent">
				<h3 class="text-center fuenteTuneada colorPrincipal titulos" id="titulo_rebote">Método addClass</h3>
			</div>
					...
					<div class="row">
						<div class="col-sm-6">
							...
							<div class="row">
								...
								<div class="col-sm-6">
									<button id="btn_change" class="btn btn-block btn-dark" title="Aplicar Función">
