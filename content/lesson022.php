...
<head>
	...
	<title>jQuery > Eventos focusin y focusout</title>
...
<body>
	<div class="container-fluid colorAcentuado" id="fondoPag">
		<div class="container bg-white">
			<div class="jumbotron bg-transparent">
				<h3 class="text-center fuenteTuneada colorPrincipal titulos" id="titulo_rebote">Eventos Focusin y Focusout</h3>
			</div>
					...
					<div class="row">
						<div class="col-sm-6">
							<div class="form-group">
								...
								<span id="id1" class="text-primary"></span>
							</div>

							<div class="form-group">
								<label for="">Apellido</label>
								<input type="text" id="txt_apellido" class="form-control">
								<span id="id2" class="text-primary"></span>
							</div>
						</div>
	...
	<script>
		$(document).ready(function() {
			...
			$("#txt_nombre").focusin(function() {
				$("#id1").html('Ingresa Tu Nombre');
			...
			$("#txt_apellido").focusin(function() {
				$("#id2").html('Ingresa Tu Apellido');

				$(this).css('backgroundColor', '#bdbdbd');
			});

			$("#txt_apellido").focusout(function() {
				$("#id2").html('');
				$(this).css('backgroundColor', '#fff');
			});
		});
