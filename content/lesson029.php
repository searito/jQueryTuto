...
<head>
	...
	<title>jQuery > Método SlideDown</title>
	...
	<div class="container-fluid colorAcentuado" id="fondoPag">
		<div class="container bg-white">
			<div class="jumbotron bg-transparent">
				<h3 class="text-center fuenteTuneada colorPrincipal titulos" id="titulo_rebote">Método SlideDown</h3>
			</div>
			...
			<div class="card espacioBajo fondoClaro">
				<div class="card-body">
					<div class="row">
						<div class="col-sm-6">
							<button id="btn_efecto" class="btn btn-dark" title="Activar Funcion">
